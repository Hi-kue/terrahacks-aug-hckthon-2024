...
export function SiteBanner() {
  return (
    <div className="relative top-0 bg-green-200 text-background py-3 md:py-0">
      <div className="container flex flex-col items-center justify-center gap-4 md:h-12 md:flex-row">
        ...
        >
          ✨
          <span className="font-bold"> Check out our AI - </span>{" "}
          See how it can help you be more eco-friendly. ✨
        </Link>
      </div>
